...
faqs:
  - question: "What's the difference between a URL and a URI?"
  ...
  - question: "How can I make a JSON response easier to read?"
    answer: "When a response comes back as raw JSON like `{\"id\":131,\"type\":\"general\",\"setup\":\"How do you organize a space party?\",\"punchline\":\"You planet.\"}`, you can paste it into a JSON formatter website such as https://jsonformatter.curiousconcept.com/ and click Process to get an indented, human-readable version."
  - question: "Why can I open the Joke API links directly in my browser?"
    answer: "Because the Joke API endpoints all use GET as the HTTP method, you can open the links directly in your browser (or just click them) and see the returned joke in JSON format, such as the random joke at https://official-joke-api.appspot.com/random_joke."
  - question: "What is the host part of a URI?"
    answer: "The host is the part of the URI that remains the same even when you change the path you're using to retrieve different information, just like how \"google.com\" doesn't change even after you search for something."
  - question: "What is the difference between HTTP and HTTPS in a RESTful API URI?"
    answer: "Both the HTTP and HTTPS protocols are used when calling RESTful APIs, and HTTPS is just a secure way to call HTTP."
---
