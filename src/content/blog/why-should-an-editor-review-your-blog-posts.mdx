...
faqs:
  - question: "Why isn't a grammar tool enough to review my blog posts?"
    answer: "Tools like Grammarly, Google Docs, or Microsoft Word are great places to start, but they were programmed by humans who make mistakes, so they aren't foolproof: they may show you misspelled words and grammatically correct phrasing, but they won't tell you when you're using a word too often or when a sentence sounds weird in a casual setting."
  - question: "Why shouldn't I just review my own writing?"
    answer: "For the same reason you shouldn't approve your own Pull Request: you may miss things that other people might notice. When you explain something it makes sense in your own head, but someone else reading the same text might understand it completely differently, so an outside reader bullet-proofs the article against misunderstandings."
  - question: "What kinds of mistakes does a professional editor catch that software misses?"
    answer: "From the author's own experience, an editor catches misspelled words the software missed, over-used and unnecessary commas, misused punctuation, inconsistencies (like writing \"Google\" everywhere except one lowercase \"google\"), repeated words that need synonyms, and sentences that need re-writing because they sound awkward."
  - question: "Do I have to set up a long, formal review process?"
    answer: "No, it doesn't have to be a long, bureaucratic process. At minimum you can use an external tool to correct basic grammar, or share your document with another person before publishing to check that it makes sense to someone else, though the best quality comes from a professional editor."
  - question: "How does an editor help if English isn't my first language?"
    answer: "As a native Spanish speaker, the author sometimes thinks first in Spanish and the translation isn't as good as hoped, so a sentence that makes sense to her may sound weird to others. An English-speaking editor helps a lot by reformulating those sentences so they read naturally."
---
