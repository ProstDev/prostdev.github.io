...
faqs:
  - question: "How do I start a blog post with ProstDev?"
    answer: "First open the Google Doc template at https://docs.google.com/document/d/1oCEdZXUnRY86MOogWeTR6Jm5IbGyvVhqoyjD9oXY-eA/edit?usp=sharing, make sure you are signed in to Google Drive, then select File > Make a copy, give it a name and choose a folder, and start editing the copy with your own content."
  - question: "How long should my article be?"
    answer: "Try to keep your article under 2,000 words if possible, with an average of about 1,500 words. If you are writing a very long post, it is best to break it down into several articles and create a series instead."
  - question: "What are the character limits for the title, excerpt, and SEO description?"
    answer: "The blog post title must be under 100 characters and should include 2-5 keywords, the excerpt should be a max of 140 characters as a short hook for the reader, and the SEO description should be 500 characters or less holding the keywords that did not fit in the title."
  - question: "What's the difference between the excerpt and the SEO description?"
    answer: "The excerpt is a short hook of max 140 characters written for the actual reader and does not need to include keywords, while the SEO description is up to 500 characters written for the search engines with the keywords that did not fit in the title, and it does not have to appear in the actual article."
  - question: "How do I add code to my article?"
    answer: "There are three types of code: for in-line code there is no formatting so put your variable, property, or other code in between quotes; short scripts of about 1-10 lines can be included directly in the post; and large scripts of more than 10-15 lines should be added in a gist file at https://docs.github.com/en/github/writing-on-github/creating-gists with the gist link provided in your Google Doc."
  - question: "How do I submit my finished article for review?"
    answer: "Click the \"Share\" button in the top right corner of Google Docs, set it to \"Anyone with the link\" and choose either \"Commenter\" or \"Editor\" as the role, click \"Copy link,\" then go to https://www.prostdev.com/contact, open the \"Contribute\" section, paste the link into the \"Link to your article\" box, fill out the rest of the fields, and click \"Submit.\""
---
